...
BEGIN
    CREATE TABLE [flashy].[Decks] (
        ...
        CONSTRAINT [FK_Decks_CreatedBy] FOREIGN KEY ([CreatedById]) REFERENCES [flashy].[Users] ([Id]) ON DELETE CASCADE
    );
END;
GO
...
BEGIN
    CREATE TABLE [flashy].[FlashCards] (
        [Id] uniqueidentifier NOT NULL,
        [Front] nvarchar(64) NOT NULL,
        [NormalizedFront] nvarchar(64) NOT NULL,
        [Back] nvarchar(64) NOT NULL,
        [NormalizedBack] nvarchar(64) NOT NULL,
        [Hint] nvarchar(128) NULL,
        [CreatedById] uniqueidentifier NOT NULL,
        [CreatedAt] datetime2 NOT NULL,
        CONSTRAINT [PK_FlashCards] PRIMARY KEY ([Id]),
        CONSTRAINT [FK_FlashCards_CreatedBy] FOREIGN KEY ([CreatedById]) REFERENCES [flashy].[Users] ([Id]) ON DELETE CASCADE
    );
END;
GO
...
BEGIN
    CREATE TABLE [flashy].[UsersDecks] (
        ...
        CONSTRAINT [PK_UsersDecks] PRIMARY KEY ([UserId], [DeckId]),
        CONSTRAINT [FK_UsersDecks_Decks] FOREIGN KEY ([DeckId]) REFERENCES [flashy].[Decks] ([Id]),
        CONSTRAINT [FK_UsersDecks_Users] FOREIGN KEY ([UserId]) REFERENCES [flashy].[Users] ([Id])
    );
END;
GO
...
BEGIN
    CREATE TABLE [flashy].[DecksFlashCards] (
        ...
        [FlashCardsId] uniqueidentifier NOT NULL,
        CONSTRAINT [PK_DecksFlashCards] PRIMARY KEY ([DeckId], [FlashCardId]),
        CONSTRAINT [FK_DecksFlashCards_Decks] FOREIGN KEY ([DeckId]) REFERENCES [flashy].[Decks] ([Id]),
        CONSTRAINT [FK_DecksFlashCards_FlashCards] FOREIGN KEY ([FlashCardId]) REFERENCES [flashy].[FlashCards] ([Id]),
        CONSTRAINT [FK_DecksFlashCards_FlashCards_FlashCardsId] FOREIGN KEY ([FlashCardsId]) REFERENCES [flashy].[FlashCards] ([Id]) ON DELETE CASCADE
    );
END;
GO
