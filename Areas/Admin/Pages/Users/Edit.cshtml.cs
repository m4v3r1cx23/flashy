...
public class EditModel : PageModel
{
    ...
    public EditModel(ApplicationDbContext context, IPasswordHasher<User> passwordHasher)
    {
        _context = context;
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        User? user = await _context.Users.FirstOrDefaultAsync(m => m.Id == InputModel.Id);
        if (user == null)
        {
            return NotFound();
        }
